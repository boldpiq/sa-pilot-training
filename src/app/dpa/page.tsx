    ...
    <main style={{ background: BG, color: "#fff", minHeight: "100vh" }}>
      <section style={{ padding: "clamp(100px, 14vw, 140px) clamp(20px, 4vw, 48px) clamp(60px, 8vw, 100px)", maxWidth: 860, margin: "0 auto" }}>
        <ScrollReveal effect="fade-up">
          ...
          <p style={{ color: MUTED, fontSize: 13, marginBottom: 8, opacity: 0.6 }}>www.boldpiq.com/dpa</p>
          ...
          <p style={{ color: MUTED, fontSize: 14, marginBottom: 48, lineHeight: 1.65 }}>
            This Data Processing Addendum (&ldquo;DPA&rdquo;) forms part of the Terms of Service (&ldquo;Agreement&rdquo;) between CINNIMON T/A BoldPiq (Reg. 2015/193038/07) (&ldquo;Processor&rdquo;, &ldquo;BoldPiq&rdquo;) and the customer (&ldquo;Controller&rdquo;, &ldquo;Client&rdquo;) and applies where BoldPiq processes Client Personal Data on behalf of the Client.
          </p>
        </ScrollReveal>
...
BoldPiq shall only process Personal Data in accordance with documented instructions from the Client, unless required by law. Client instructs BoldPiq to process Personal Data solely as necessary to provide the Services and as further documented in this DPA and the Agreement. BoldPiq will promptly inform Client if, in its opinion, an instruction infringes Applicable Law. Client is responsible for the lawfulness of its instructions and for required notices/consents.`,
            },
            {
              ...
              body: `Subject Matter: processing of Client Personal Data to provide BoldPiq services.
...
Categories of Data Subjects: Client's customers, leads, prospects, employees, and contractors as determined by the Client.`,
            },
            {
              ...
              body: `BoldPiq shall implement and maintain appropriate technical and organizational measures (TOMs) designed to protect Personal Data, including at a minimum:
...
Security Incident Notice. BoldPiq shall notify Client without undue delay and no later than 72 hours after becoming aware of a Security Incident affecting Client Personal Data, and provide information reasonably available for Client to meet its breach-notification obligations.`,
            },
            {
              ...
              body: `BoldPiq may engage Sub-Processors for delivery of its services, including but not limited to:
...
Client consents to BoldPiq's use of such Sub-Processors.`,
            },
            {
              ...
              body: `BoldPiq will assist the Client in fulfilling obligations to respond to Data Subject requests, including rights of access, correction, deletion, objection, and portability.
...
Data Subject requests sent directly to BoldPiq will be forwarded to the Client without undue delay.`,
            ...
            },
            {
              ...
              body: `Upon written request, BoldPiq will make available information reasonably necessary to demonstrate compliance with this DPA.
...
Audit findings constitute BoldPiq Confidential Information.`,
            },
            {
              ...
              body: `Upon termination or expiry of the Services, Client may request a machine-readable export of Personal Data processed by BoldPiq.
...
Assistance beyond standard export/deletion tooling may incur reasonable fees.`,
            ...
            },
            {
              ...
              body: `To the extent BoldPiq processes Personal Information (as defined by CCPA/CPRA) on behalf of Client, BoldPiq acts as a Service Provider/Contractor and shall:
...
support@boldpiq.com`,
            ...
            <div key={section.title} style={{ borderBottom: `1px solid ${BORDER}`, paddingBottom: 32 }}>
              <h2 style={{ fontSize: 18, fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 12, color: "#fff" }}>{section.title}</h2>
