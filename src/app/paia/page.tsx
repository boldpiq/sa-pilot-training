    ...
    <main style={{ background: BG, color: "#fff", minHeight: "100vh" }}>
      <section style={{ padding: "clamp(100px, 14vw, 140px) clamp(20px, 4vw, 48px) clamp(60px, 8vw, 100px)", maxWidth: 860, margin: "0 auto" }}>
        <ScrollReveal effect="fade-up">
          ...
          <p style={{ color: MUTED, fontSize: 13, marginBottom: 8, opacity: 0.6 }}>www.boldpiq.com/PAIA</p>
          ...
          <p style={{ color: MUTED, fontSize: 14, marginBottom: 48, lineHeight: 1.65 }}>
            FOR BOLDPIQ (PTY) LTD{"\n"}
            This PAIA Manual is compiled in accordance with Section 51 of the Promotion of Access to Information Act, No. 2 of 2000 ("PAIA"). It provides guidance on how interested parties may request access to records held by BoldPiq (Pty) Ltd. In addition to our general business operations, BoldPiq&apos;s activities include website development, hosting, and maintenance services (delivered via the gohighlevel platform), for which related records are maintained in accordance with legal and contractual obligations.
          </p>
        </ScrollReveal>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
            {[
              ...
              },
              {
                ...
                body: "Company Name: Boldpiq (Pty) Ltd\nWebsite: www.boldpiq.com",
              },
              {
              ...
              },
              {
                ...
                body: `BoldPiq's core operations include:
...
As part of these operations, BoldPiq generates and retains records including:
Details of the agreed scope for website development and subsequent change orders. Hosting and maintenance logs, including records of monthly fees, service reactivation, and termination notices. Agreements and contractual documents such as the Website Development and Maintenance Agreement. Data pertaining to both Client Content (supplied by clients for website development) and Developer Content (including licensed templates, stock images, and code). Records of communications, financial transactions, and data processing related to service delivery.`,
              },
              {
                ...
                body: `BoldPiq makes certain categories of records publicly accessible without a formal PAIA request. These include:
...
Agreements and Contracts: Such as the Website Development and Maintenance Agreement that governs the relationship between BoldPiq and its clients.
...
Client Content: BoldPiq receives and stores content provided by clients (such as images, logos, and textual information) necessary for website development.
Developer Content: BoldPiq may incorporate licensed stock images, templates, and proprietary code elements in website development. Such materials remain the property of BoldPiq and are licensed solely for use on the client's website for the duration of the service agreement.

10.2 Data Retention

BoldPiq retains data essential for website operations only for the duration of the service agreement. Upon termination of services or deactivation of a website, BoldPiq reserves the right to permanently delete all related data from its servers. Clients are responsible for backing up any necessary data.

10.3 Data Privacy and POPIA Compliance

BoldPiq is fully committed to protecting personal information in accordance with the Protection of Personal Information Act (POPIA). Personal data obtained through our website services is processed solely for the purpose of service delivery and is safeguarded with appropriate technical and organisational measures. BoldPiq will not sell, share, or transfer personal data to third parties without explicit consent, except as required by law. Upon termination of services, personal data will be securely deleted or returned in accordance with POPIA requirements.`,
              },
              {
                title: "11. Records Pertaining to the Website Development and Maintenance Agreement",
                body: `In addition to general records, BoldPiq maintains specific records in relation to our Website Development and Maintenance services:
...
Termination and Data Post-Termination Records: Records relating to the termination of services, outstanding payments, and subsequent data deletion or retention practices.`,
              },
              {
                ...
                body: `BoldPiq's operations, including website development and maintenance, are governed by our Terms of Service and Privacy Policy which further elaborate on:
...
On the BoldPiq website: www.boldpiq.com
At BoldPiq's principal place of business during office hours`,
              },
              {
                title: "14. Updates to This Manual",
                body: "This manual will be reviewed periodically to ensure ongoing compliance with legal requirements and to reflect any changes in BoldPiq's operations or data handling practices. Updates will be documented and published accordingly.",
              },
              {
                title: "15. Legal Notice",
                body: "This manual is intended solely to provide guidance on accessing records held by BoldPiq (Pty) Ltd in accordance with PAIA. It does not modify, supersede, or affect any contractual agreements (such as the Website Development and Maintenance Agreement) between BoldPiq and its clients.",
              },
              {
